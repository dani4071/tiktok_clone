...
import 'package:tiktok_clone/src/features/shop/following/controller_following_video.dart';
...
class _followingsVideoScreenState extends State<followingsVideoScreen> {
  ...
  Widget build(BuildContext context) {
    final ControllerFollowingVideos controllerFollowing = Get.put(ControllerFollowingVideos());

    return Scaffold(
        backgroundColor: Colors.green,
        body: Obx(() {
          return PageView.builder(
            itemCount: controllerFollowing.followingAllVideoList.length,
            controller: PageController(viewportFraction: 1, initialPage: 0),
            scrollDirection: Axis.vertical,
            itemBuilder: (context, index) {
              final eachVideoInfo = controllerFollowing.followingAllVideoList[index];
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        IconButton(
                                            onPressed: () {
                                              controllerFollowing.likeOrUnlikeVideos(eachVideoInfo.videoID.toString());
                                            },
                                            icon: Icon(
