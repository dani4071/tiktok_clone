...
class _forYouScreenState extends State<forYouScreen> {
  ...
  Widget build(BuildContext context) {
    final ControllerForYou forYouController = Get.put(ControllerForYou());

    return Scaffold(
        backgroundColor: Colors.green,
        body: Obx(() {
          return PageView.builder(
            itemCount: forYouController.forYouAllVideoList.length,
            controller: PageController(viewportFraction: 1, initialPage: 0),
            scrollDirection: Axis.vertical,
            itemBuilder: (context, index) {
              final eachVideoInfo = forYouController.forYouAllVideoList[index];
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    IconButton(
                                        onPressed: () {
                                          forYouController.likeOrUnlikeVideos(eachVideoInfo.videoID.toString());
                                        },
                                        icon: Icon(
